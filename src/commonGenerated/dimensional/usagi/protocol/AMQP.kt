  ...
  public object Connection {
    public data class Start(
      ...
      public class Builder {
        ...
        public fun build(): Start = Start(versionMajor, versionMinor, serverProperties, mechanisms,
            locales, )
      }
    }
  ...
  public object Exchange {
    public data class Declare(
      ...
      public class Builder {
        ...
        public fun build(): Declare = Declare(ticket, exchange, type, passive, durable, autoDelete,
    ...
    public data class Bind(
      ...
      public class Builder {
        ...
        public fun build(): Bind = Bind(ticket, destination, source, routingKey, nowait, arguments,
            )
      }
    }
    ...
    public data class Unbind(
      ...
      public class Builder {
        ...
        public fun build(): Unbind = Unbind(ticket, destination, source, routingKey, nowait,
            arguments, )
      }
    }
  ...
  public object Queue {
    public data class Declare(
      ...
      public class Builder {
        ...
        public fun build(): Declare = Declare(ticket, queue, passive, durable, exclusive,
  ...
  public object Basic {
    ...
    public data class Consume(
      ...
      public class Builder {
        ...
        public fun build(): Consume = Consume(ticket, queue, consumerTag, noLocal, noAck, exclusive,
            nowait, arguments, )
      }
    }
    ...
    public data class Deliver(
      ...
      public class Builder {
        ...
        public fun build(): Deliver = Deliver(consumerTag, deliveryTag, redelivered, exchange,
            routingKey, )
      }
    }
    ...
    public data class GetOk(
      ...
      public class Builder {
        ...
        public fun build(): GetOk = GetOk(deliveryTag, redelivered, exchange, routingKey,
            messageCount, )
      }
    }
    ...
    public data class Properties(
      ...
      public class Builder {
        ...
        public fun build(): Properties = Properties(contentType, contentEncoding, headers,
